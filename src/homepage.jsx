          ...
          <div style={{ marginTop: '3rem', maxWidth: '1000px', margin: '3rem auto 0', padding: '0 1rem' }}>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '2rem' }}>
              ...
              <div style={{ maxWidth: '100%' }}>
                <div style={{ padding: '177.78% 0 0 0', position: 'relative', background: 'black' }}>
                  <iframe 
                    src="https://player.vimeo.com/video/1207582505?badge=0&autopause=0&player_id=0&app_id=58479"
                    frameBorder="0"
                    allow="autoplay; fullscreen; picture-in-picture; clipboard-write"
                    style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%' }}
              ...
              <div style={{ maxWidth: '100%' }}>
                <div style={{ padding: '177.78% 0 0 0', position: 'relative', background: 'black' }}>
                  <iframe 
                    src="https://player.vimeo.com/video/1207582657?badge=0&autopause=0&player_id=0&app_id=58479"
                    frameBorder="0"
                    allow="autoplay; fullscreen; picture-in-picture; clipboard-write"
                    style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%' }}
